   ...
   real(dl) Lambdac, alphaBDE, wDGc, ac, norm_pot
    ...
    !erick30.11.19  CosmoMC modification. We set fixq = 0._dl (since in CosmoMC we evolve all of the modes)
    ...
    !erick30.11.19 CosmoMC modification. We remove tauac from the set of global parameters, since
    !              this variable is not used in cmbmain/GetTransfer. In fact,
    !              this variable is not used either in that subroutine (see the explanation)
    !real(dl) tauac
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! Transfer - begins !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    !erick30.11.19 CosmoMC modification. When running CosmoMC we don't create these files
    !However, the info of sigma8 & fsigma8 at selected z's is exported to the chains
