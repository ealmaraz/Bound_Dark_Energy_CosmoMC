    ...
    !erick30.11.19 This is to import the (fixed) values of wDGc, Ncolors & Nflavors from test.ini
    !We recall that wDGc is expressed in multiples of 1/3
    wDGc = Ini%Read_Double('wDGc')/3._mcp
    Ncolors = Ini%Read_Double('Ncolors')
    Nflavors = Ini%Read_Double('Nflavors')
